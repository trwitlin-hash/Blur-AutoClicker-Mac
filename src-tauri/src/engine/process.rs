...
// Process enumeration is not implemented on macOS; the process-list feature
// degrades to "always allowed". The Windows implementation used Win32 APIs that have
...
/// Normalize a process name: lowercase and strip the path;
